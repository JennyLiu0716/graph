...
// Originally graph/algorithms/GraphSearchTest.java. 
...
class AlgorithmsTest {
    ...
    // // System.out.println(adjgraph[adj[j][k]].length+"
    // "+adjgraph[adj[j][k-1]].length);
    // }
    // }
    // }
    // }
    ...
    // int[][] adj = GraphSearch.sortAdjacencyLists(adjgraph, degree);
    // boolean found ;
    // // for each vertex on level (i), it must be a neighbor of one of the vertex
    // on level (i-1)
    ...
    // // L1 is lexicographically larger than L2 if the minimum element in L1\L2 &
    // L2\L1 belongs to L1
    ...
    // // the label of nodeOrder[j+1] is lexicographically larger than any node from
    // j+2 to n;
